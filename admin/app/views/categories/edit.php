    ...
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="categories/edit/<?php echo $categorie['id'] ?>" method="POST">
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="<?php echo $categorie['name'] ?>" class="mt-2 px-4 py-2 w-full border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                <input type="text" id="description" name="description" value="<?php echo $categorie['description'] ?>" class="mt-2 px-4 py-2 w-full border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
            </div>
